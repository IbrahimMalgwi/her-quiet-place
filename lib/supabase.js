...
export const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
    auth: {
        storage: AsyncStorage, // ✅ Essential for session persistence
        persistSession: true, // ✅ Keep users logged in
        autoRefreshToken: true, // ✅ Automatically refresh expired tokens
        detectSessionInUrl: false, // ✅ Crucial - prevents OAuth redirect issues in RN
        flowType: 'pkce', // ✅ Better security for mobile apps
    },
});